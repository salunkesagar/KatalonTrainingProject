...
WebUI.callTestCase(findTestCase('Demo/CallTestCaseDemo'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Welcome Yashviitha                     _60868f'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome Yashviitha'))
